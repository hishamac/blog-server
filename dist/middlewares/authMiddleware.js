...
exports.blogger = exports.admin = exports.protect = void 0;
...
const admin = (req, res, next) => {
    if (req.user && req.user.role === User_1.Role.ADMIN) {
        next();
    }
    else {
...
const blogger = (req, res, next) => {
    if (req.user &&
        (req.user.role === User_1.Role.BLOGGER || req.user.role === User_1.Role.ADMIN)) {
        next();
    }
    else {
